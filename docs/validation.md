...
- 65 pytest cases passed: input validation, scope expiry/allowlists, CPE evidence,
  ...
  mocked MessagePack health requests.
...
tested; no RPC service or credentials were available. There is no NVD fetcher,
active scanning, payload/exploit automation, or measured 60% improvement claim.
